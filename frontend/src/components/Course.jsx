        ...
        <div onMouseLeave={handleMouseLeave}>
            ...
            <div className="carrusel-perfiles">
                ...
                <div className="contenedor-iconos-l-h">
                    <div className="icons">
                        <svg onClick={Hate} className="hate-buton" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128.07 127.89">
                        ...
                        <svg onClick={Like} className="like-buton" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128.06 127.99">
