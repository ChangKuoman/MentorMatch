...
const CoursePage = () => {
    ...
    // logica para las cards

    return (
        <div onMouseLeave={handleMouseLeave}>
            <div className="frame1-course-page"></div>
            <p className="titleCoursePage">MENTOR MATCH</p>
            <div className="frame2-course-page"></div>
